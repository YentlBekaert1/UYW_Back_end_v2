...
final class FaqTable extends PowerGridComponent
{
    ...
    *
    * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\faq>|null
    */
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', function(faq $model) {
                return Carbon::parse($model->created_at)->format('d/m/Y H:i:s');
            })
            ->addColumn('updated_at_formatted', function(faq $model) {
...
;
    ...
    */
    ...
    {
       try {
           $updated = faq::query()->findOrFail($data['id'])
                ->update([
