                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Make a new submaterial.</h3>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('web.submaterials.store')}}" class="mt-8 space-y-6" enctype="multipart/form-data">
                        @csrf
