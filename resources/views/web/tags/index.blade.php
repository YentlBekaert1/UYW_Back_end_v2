...
<x-slot name="header" >
        <div  class="grid grid-cols-1 md:grid-cols-2">
            ...
            <a href="{{route('web.tags.create')}}" style="width: fit-content; justify-self: end; background-color: #42998B; color: white; padding: 0.2rem 2rem; border-radius: 5px;">Maak een nieuw tag</a>
        </div>
    </x-slot>
    ...
    <div class="mt-3 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-4 py-8 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <h1 class="py-4 text-lg font-medium leading-6 text-gray-900"">Hieronder vind u de tag die gebruikt kunnen worden op het platfrom.</h1>
                <p>De tags kunnen worden gewijzigd of worden verwijderd.</p>
