                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Hier kun je een nieuwe categorie aanmaken.</h3>
                            </div>
                        </div>
                        ...
                        @csrf
                            ...
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div class="col-span-3 sm:col-span-2">
                                    ...
                                    <div class=" flex rounded-md shadow-sm">
                                        <input type="text" id="description" name="description" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
                                    </div>
                                </div>
                                ...
                                <div class="col-span-3 sm:col-span-2">
                                    ...
                                    <div class=" flex rounded-md shadow-sm">
                                        <input type="text" id="description_en" name="description_en" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
                                    </div>
                                </div>
                                ...
                                <div class="col-span-3 sm:col-span-2">
                                    ...
                                    <div class=" flex rounded-md shadow-sm">
                                        <input type="text" id="description_fr" name="description_fr" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
                                    </div>
                                </div>

                            </div>
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-500 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Bewaar categorie</button>
                            </div>
                            </div>
                        </form>
                        </div>
