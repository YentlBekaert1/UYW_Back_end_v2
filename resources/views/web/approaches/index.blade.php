<x-app-layout>
    ...
    <div class="mt-3 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-4 py-8 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <h1 class="py-4 text-lg font-medium leading-6 text-gray-900"">Hieronder vind u alle insteken die gebruik kunnen maken van het platfrom</h1>
                <p>De insteken kunnen worden gewijzigd of worden verwijderd.</p>
